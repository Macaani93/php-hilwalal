...
if(isset($_POST['login'])){
    ...
    $login = mysqli_query($conection,"SELECT * FROM users WHERE UserName= '$username' AND Password= '$password'");
    $countuser=mysqli_num_rows($login);
    $result =mysqli_fetch_array($login);
    if ($countuser > 0){
        $_SESSION['ID']=$result[0];
        $_SESSION['Name']=$result[1];
        $_SESSION['Phone']=$result[2];
        $_SESSION['UserName']=$result[3];
        // $_SESSION['Password']=$result[4];
